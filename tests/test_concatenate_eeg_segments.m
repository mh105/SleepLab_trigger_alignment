...
edf_eeg_total_sample_count = 20;

final_eeg_data = concatenate_eeg_segments( ...
    eeg_segment_data, matched_segments, edf_input, ...
    aligned_eeg_channel_names, edf_eeg_total_sample_count);

expected = zeros( ...
    11, edf_eeg_total_sample_count, 'single');
...
expected_mask = false(1, edf_eeg_total_sample_count);
